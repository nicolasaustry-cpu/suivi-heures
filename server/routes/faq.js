...
router.post("/seed", verifyToken, verifyAdmin, async (req, res) => {
  try {
    const base = [
      ["Connexion & licence", "Comment me connecter ?", "Ouvrez l'application, saisissez votre code de licence puis cliquez sur « Activer la licence ». Le code est mémorisé et pré-rempli lors des connexions suivantes. Vous restez ensuite connecté tant que votre licence est valide : l'application renouvelle la session automatiquement en arrière-plan, sans rien vous demander."],
      ["Connexion & licence", "Que se passe-t-il quand ma licence expire ?", "À la date d'expiration définie à la création de la licence (ou si la licence est désactivée), la connexion est refusée et vous revenez à l'écran de connexion. Tant que la licence est valide, vous restez connecté sans avoir à ressaisir votre code. Aucune donnée n'est perdue."],
      ["Connexion & licence", "Mon code de licence ne se pré-remplit pas.", "Le code n'est mémorisé qu'après une première activation réussie sur cet appareil et ce navigateur. Sur un nouvel appareil, en navigation privée, ou après effacement des données du navigateur, il faut le ressaisir une fois. Le nom de l'entreprise, lui, apparaît après connexion, une fois les données synchronisées."],
      ...
      ["Entreprise", "Comment régler ou figer les seuils des jauges ?", "Page Entreprise, Paramétrage des jauges : ajustez Seuil rouge, Seuil orange et Zone verte. Cochez « Figer les seuils » puis Enregistrer pour les verrouiller. Les seuils expriment le pourcentage des heures achetées (salariés) qu'il faut vendre pour atteindre vos objectifs ; nous conseillons 85 % pour le rouge et 90 % pour l'orange."],
      ["Entreprise", "Existe-t-il un guide pour bien démarrer ?", "Oui : le guide « Bien démarrer » reprend pas à pas la mise en route (entreprise, salariés, téléphones, prévisionnel, planning, saisie mobile, suivi, paie). Il est joint en PDF au mail d'accès et reste téléchargeable depuis la page Entreprise."],
      ["Entreprise", "Où indiquer le point de départ et les zones d'indemnités de trajet ?", "Page Entreprise, tuile « Zones d'indemnités de trajet » : saisissez l'adresse de départ de l'entreprise (atelier ou siège) et ajustez si besoin les limites de chaque zone. Barème proposé par défaut : IA 0-5 km, IB 5-10, II 10-20, III 20-30, IV 30-40, V 40-50, VI 50-65, VII au-delà de 65 km. Ces réglages servent à proposer automatiquement la tranche de trajet dans les Éléments Pointage Paie."],
      ["Entreprise", "Comment afficher dans le planning les rendez-vous pris sur Reservio ?", "Page Entreprise, section « Connexion Reservio » : cochez l'activation puis collez, pour chaque salarié, l'adresse du calendrier fournie par Reservio (plusieurs adresses possibles par salarié). Les rendez-vous à venir sont repris automatiquement toutes les 15 minutes dans le planning."],
      ...
      ["Prévisionnel", "Que signifient les couleurs des lignes du Prévisionnel ?", "Fond blanc : chantier prévu, pas encore planifié sur le mois. Vert : chantier prévu et planifié dans le Planning sur ce mois. Jaune : chantier planifié mais non prévu au devis. La ligne jaune est déjà dans le Prévisionnel (elle remonte automatiquement du Planning) : inutile de l'ajouter, il suffit de compléter ses heures prévues si besoin."],
      ["Prévisionnel", "Puis-je importer mes devis validés depuis Henrri ?", "Cette fonction est bientôt disponible : les devis validés dans Henrri pourront être repris dans le Prévisionnel en quelques clics. En attendant, saisissez vos chantiers directement dans le tableau."],
      ...
      ["Planning", "Comment renseigner l'adresse et les téléphones d'un chantier ?", "Dans le Planning prévu, ouvrez la fiche du chantier (bouton 🗒 sur le pavé, puis le bouton des coordonnées) et saisissez l'adresse, la ville et les téléphones. Ils sont repris sur tous les jours où ce chantier est planifié et visibles par le salarié sur son téléphone. L'adresse sert aussi à proposer la tranche d'indemnité de trajet."],
      ["Planning", "Que signifient les pictos 🔗 et 🔒 sur un rendez-vous ?", "Ils concernent les rendez-vous importés de Reservio. 🔗 : le créneau suit Reservio et se met à jour tout seul. 🔒 : vous l'avez modifié à la main (chantier, heures, heure de RDV ou technicien), il n'est plus jamais retouché automatiquement. Si un rendez-vous verrouillé est annulé sur Reservio, une alerte vous demande de le conserver ou de le supprimer."],
      ...
      ["Suivi des entretiens", "À quoi sert le Suivi des entretiens ?", "À retrouver en un seul écran les interventions marquées « Entretien 1 an » ou « Entretien 2 ans » dans le Planning, pour savoir quels clients relancer et quand."],
      ["Suivi des entretiens", "Comment activer le Suivi des entretiens ?", "Page Entreprise : cochez « Activer la page Suivi des entretiens » puis cliquez « 💾 Valider ». La page se recharge et le lien « Suivi des entretiens » apparaît dans le menu. Même manipulation (décocher puis Valider) pour le désactiver."],
      ["Suivi des entretiens", "Comment marquer une intervention comme entretien ?", "Dans le Planning, ouvrez la note du chantier sur la journée concernée : en haut de la fenêtre, cochez la case orange « Entretien 1 an » ou « Entretien 2 ans » et ajoutez si besoin un commentaire dédié. L'intervention est alors reprise dans le Suivi des entretiens."],
      ["Suivi des entretiens", "Je ne vois ni le menu Suivi des entretiens ni les cases Entretien.", "La fonction n'est pas activée pour votre entreprise : cochez « Activer la page Suivi des entretiens » dans la page Entreprise puis cliquez « 💾 Valider »."],
      ...
      ["Planning réalisé", "Que signifie la ligne violette « 🍽️ Pause déjeuner » ?", "C'est la pause déjeuner hors chantier déclarée par le salarié sur son téléphone. Elle est affichée pour information et n'est jamais comptée dans le temps de travail ni dans les totaux."],
      ...
      ["Saisie mobile", "Comment déclarer la pause déjeuner ?", "Le bouton violet « Pause déjeuner » apparaît sous le dernier chantier envoyé : l'ouvrier indique la durée et valide. Une seule pause déjeuner par jour. Elle est prise en dehors des chantiers et n'est jamais comptée comme temps de travail ; elle est différente de la pause prise sur un chantier."],
      ["Saisie mobile", "Que signifie le pavé Contrat / Planifié / Réalisé ?", "En bas de la journée : Contrat = heures prévues au contrat ce jour-là (semaine A/B, jours fériés et jours d'école des apprentis pris en compte) ; Planifié = heures posées au planning ; Réalisé = heures réellement saisies par l'ouvrier."],
      ["Saisie mobile", "Comment l'ouvrier lance-t-il l'itinéraire vers un chantier ?", "Si l'adresse du chantier est renseignée, le bouton « 🗺 Itinéraire » s'affiche à droite de l'adresse sur la carte du chantier : il ouvre Google Maps (ou l'application de cartes du téléphone) avec le trajet. Les numéros de téléphone sont cliquables pour appeler."],
      ["Saisie mobile", "Quelle différence entre « 📋 Note » et le bouton « 📝 Note » ?", "« 📋 Note » est la note écrite au bureau dans le Planning : l'ouvrier la lit (avec les documents joints) mais ne peut pas la modifier. Le bouton « 📝 Note » sert à l'ouvrier pour écrire ou dicter sa propre note et joindre jusqu'à 3 photos ; elle part avec le chantier."],
      ...
      ["Rapports & données", "Comment imprimer une fiche récapitulative d'un chantier ?", "Page Rapports : sélectionnez un seul chantier dans le filtre Chantier(s), puis cliquez « 🖨 Fiche chantier ». Une fiche imprimable s'ouvre avec les coordonnées du client, les dates d'intervention, les notes et photos de chaque intervention et le carnet de chantier."],
      ...
      ["Notes", "Comment modifier ou supprimer une note ?", "Page Notes : le bouton ✏️ de la note ouvre une fenêtre pour compléter ou corriger le texte et gérer les photos, puis Enregistrer. Le bouton 🗑 la supprime."],
      ["Notes", "Comment ajouter une note manuellement ?", "Page Notes : bouton « ✚ Ajouter une note ». Choisissez l'intervenant puis l'intervention concernée, rédigez la note et ajoutez des photos si besoin."],
      ["Notes", "Comment corriger le nom d'un chantier ?", "Page Notes : sélectionnez le chantier dans le filtre Chantier puis cliquez « ✏️ Renommer ». Le nouveau nom est appliqué partout (Planning, Prévisionnel, coordonnées et notes), ce qui permet de tout retrouver sous le même nom, y compris dans la fiche chantier."],
      ...
      ["BEV", "À quoi sert le BEV ?", "Le Bordereau d'Éléments Variables (page Éléments Pointage Paie) prépare la paie de chaque salarié, mois par mois : heures, base, écarts et indemnités de trajet et de repas."],
      ...
      ["BEV", "Comment la tranche d'indemnité de trajet est-elle proposée ?", "À partir de la distance à vol d'oiseau entre le point de départ de l'entreprise et l'adresse du chantier (réalisé, ou planning à défaut). Si le salarié a plusieurs chantiers dans la journée, c'est le plus éloigné qui compte. La tranche proposée s'affiche en gris avec la mention « auto » : vous pouvez la modifier librement. Elle ne remplace jamais une tranche déjà saisie et rien n'est proposé sur un mois validé."],
      ["BEV", "Pourquoi une case de trajet reste vide avec un ⚠ ?", "L'adresse du chantier n'est pas renseignée ou n'a pas été trouvée. Cliquez sur le ⚠ pour ouvrir la fiche du chantier et compléter son adresse ; la tranche sera alors proposée."],
      ["BEV", "Où est passée l'indemnité de transport ?", "Elle a été retirée : seules les indemnités de trajet et de repas figurent désormais dans les Éléments Pointage Paie. Les données de transport déjà saisies sont conservées, mais ne sont plus affichées ni comptées."],
